...
- **@adamnusic** - Hang Out space ($HANGOUT)
- **@songjam** - Platform host
- More coming soon!
...
- **Platform**: [my.songjam.space](https://my.songjam.space)
- **Twitter**: [@SongjamSpace](https://twitter.com/SongjamSpace)
- **Token**: $SANG

## Contributing

Found a bug? Have a suggestion? Open an issue or PR! We're building this together.

---

**Ready to give your agent a voice?** Start with the [Quick Start Guide](docs/QUICKSTART.md) 🎵
